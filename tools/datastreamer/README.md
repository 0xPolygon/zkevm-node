...
- **Truncate**: Truncates the file to a given entry number. Useful in case of unwinding the network. It can be updated to be able to truncate to a given batch number instead of entry number.
